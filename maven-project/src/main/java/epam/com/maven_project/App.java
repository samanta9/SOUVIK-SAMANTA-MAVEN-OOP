	...
	void display()
	   {
			...
			System.out.println("\n the hierarchy of  sweet by amount are :");
			for(int i=0;i<5;i++)
			  {
	...
	void display()
	    {
			   ...
			   System.out.println("\n the hierarchy of chocolate by amount are :");
	 ...
	 void weight()
	    {
		  ...
		  System.out.println("\n enter 5 weights( in gm)  of  collected children's gift :");
	           for(int i=0;i<5;i++)
	                {
		                w[i]=sc.nextFloat();
	                }
	           ...
	           low=sc.nextFloat();
			    System.out.println("\n enter the  upper  limit  weight to find the candies :");
	                high =sc.nextFloat();
					 ...
					 System.out.println("\n enter the   weight to find the candies :");
	                     range=sc.nextFloat();
						 if(range>=low && range<=high)
						 {
							 
							 System.out.println("\n the candies are available ");
							 
						 }
						 else
						 {
							 
							 System.out.println("\n sorry the candies are not available now !!!!!!");
						 }
